        ...
        if uploaded_files:
            ...
            for i, f in enumerate(uploaded_files):
                ...
                try:
                    ...
                    supabase.table("dixit_pool_pulham").insert({"url": public_url}).execute()
                    count += 1
...
st.markdown(
    ...
    '<a href="https://lxests6fmsfr8zsztpvzpz.streamlit.app/" target="_blank" '
...
# ============================================================
def refill_hands():
    pool_res = supabase.table("dixit_pool_pulham").select("url").execute()
